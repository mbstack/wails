...
## Astro 
- [wails-astro-daisyui-preact-template](https://github.com/mbstack/wails-astro-daisyui-preact-template) - A starter template with Astro for frontend rendering, Preact for lightweight UI, Tailwind CSS + DaisyUI for styling, and Vite for fast bundling.
